...
def boavinda(message1):
    ...
    if ide in liste:
        ...
        bot.send_message(ide, '<b>' '✅ Adquira o seu acesso com meu Dono @FuckU_256 ✅' '</b>', parse_mode='HTML')
...
def beroi(men):
            ...
            if int(idee) in permitidos:
                ...
                bot.reply_to(men, '<b>' '✅ Compre acesso com meu Dono @FuckU_256 ✅' '</b>', parse_mode='HTML')
...
def byti(men):
            ...
            if int(chtid) in permitidos:
                ...
                bot.reply_to(men, '<b>✅ Compre acesso com meu Dono @FuckU_256 ✅</b>',
                             parse_mode='HTML')
...
def sjjsn(nome):
            ...
            if id1 in ltnome:
                ...
                bot.reply_to(nome, '<b>✅ Compre acesso com meu Dono @FuckU_256✅</b>',
                             parse_mode='HTML')
...
def bunda(message1):
            ...
            if ideee in lib:
                ...
                bot.reply_to(message1,
                             '<b>' + '✅ Adquira acesso com meu dono @FuckU_256 ✅' + '</b>',
                             parse_mode='HTML')

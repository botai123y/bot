...
bot = telebot.TeleBot('1454790448:AAG3hVwx2BqsT27yyYBwtnN90YK8cIzKnlc')

PRIVADO = [1433217230,800080254,
640672725,1172087694,1317447287,1297741752,1466774462,1201717621,1440123969,1000707909,1150580646,1042490304,1122333934,1257495086,1323211684,1270936843,1322816678,1330534725,907745300,1433006346,1166690603,1180107506,1424790595,1317447287,1407073035,1438064726,1062934164,1440123969,1043010793,937463161,1331704056,1442636185,1051376153,1214157821,1371104339,1227227519,1432785110,1056540638,1183207064,914300425,1452577790,1263934958,1483426719]
#
#
...
def boavinda(message1):
    ...
    if ide in liste:
        ...
        bot.send_message(ide, '<b>' '✅ Adquira acesso com @NagisaBuscas_OFC ✅' '</b>', parse_mode='HTML')
            ...
            if id1 in ltnome:
                try:
                	...
                	bot.reply_to(nome, '<b>' 'TÁ ERRADO, IDIOTA!' '</b>', parse_mode='HTML')
                		...
                		bot.reply_to(nome, '<b>' '✅ Compre acesso com @NagisaBuscas_OFC ✅' '</b>', parse_mode='HTML')
...
def byti(men):
            ...
            if int(chtid) in permitidos:
                ...
                bot.reply_to(men, '<b>✅ Compre acesso com @NagisaBuscas_OFC ✅</b>',
                             parse_mode='HTML')
...
def bxniy(men):
            ...
            if bid in liberadoip:
                ...
                bot.reply_to(men, '<b>✅ Compre acesso com @NagisaBuscas_OFC ✅</b>', parse_mode='HTML')
...
def sjjsn(nome):
            ...
            if id1 in ltnome:
                ...
                bot.reply_to(nome, '<b>✅ Compre acesso com @NagisaBuscas_OFC ✅</b>',
                             parse_mode='HTML')
                    ...
                    try:
                        ...
                        bot.reply_to(men, '<b>' '🔍 CONSULTA REALIZADA 🔎' '</b>' + '\n\n<b>NOME: </b><code>' + str(
                            ...
                            resp['enderecoComplemento']) + '</code>\n' + '<b>BAIRRO: </b><code>' + resp[
                                         "enderecoBairro"] + '</code>\n' +
                                     '<b>CEP: </b><code>' + cep + '</code>\n\n' + '<b>TELEFONES: </b>\n' + tel + '<b>RG: </b> \n\n' + rgg + '\n<b>CERTIDÃO: </b>\n\n' + certidao + '<b>CARTOES AGREGADOS: </b>\n\n' + cart
                                     + '\n<b>GRUPO: @NagisaGroupe\nGRUPO²: @canalnagisa\nGRUPO³: @Consultassociety</b>', parse_mode='HTML')
                    except:
                        A = bot.reply_to(men, '<b>' 'OPS, NÃO ENCONTRADO!' '</b>', parse_mode='HTML')
            else:
                bot.reply_to(men, '<b>' '✅ Compre acesso com @NagisaBuscas_OFC✅' '</b>',
...
def bunda(message1):
            ...
            if ideee in lib:
                ...
                bot.reply_to(message1,
                             '<b>' + '✅ Adquira acesso com meu @NagisaBuscas_OFC✅' + '</b>',
                             parse_mode='HTML')
                                    ...
                                    try:
                                        bot.reply_to(nome,
                                                     ...
                                                     str(ar1[19].text) + '\nCPF/CNPJ: ' + re.sub('[^0-9]', '',
                                                                                                 ar[90].html) + '\n\n' +
                                                     str(ar1[20].text) + '\nCPF/CNPJ: ' + re.sub('[^0-9]', '', ar[
                                                         95].html) + '\n\n<b>GRUPO: @NagisaGroupe</b>', parse_mode='HTML')
                                    except:
                                        try:
                                            bot.reply_to(nome,
                                                         '<b>[FORMATO DA CONSULTA ]\n\nNOME:\nDATA DE NACIMENTO:\nNOME MAE:\nESTADO:\nCPF:\n\n</b>' + str(

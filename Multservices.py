...
def bniio(men):
    ...
    if men.text == '/menuu':
        ...
        try:
        	bot.reply_to(men, '<b>' '🇧🇷 StarkBOT 🇧🇷' '</b>' + '\n\n' + '<b>' 'CEP ➔</b><code> /cep [ VIP ]' '</code>' + '\n' + '<b>' 'BIN:</b><code> /bin [ VIP ]' + '</code>' '\n' + '<b>' 'CNPJ ➔</b><code> /cnpj [ VIP ]' + '</code>' '\n' + '<b>' 'CPF: ' '</b>''<code>' '/cpf [ VIP ]' '</code>' + '\n' + '<b>' 'TRABALHOS ➔ ' '</b>''<code>' '/trabalhos [ VIP ]' '</code>' + '\n' + '<b>' 'TELEFONE ➔ ' '</b>' '<code>' + '/tel [ VIP ]' + '</code>' + '\n' + '<b>' 'NOME ➔ ' '</b>' '<code>' + '/nome [ VIP ]' + '</code>' + '\n' + '<b>' 'VIZINHOS ➔ ' '</b>' '<code>' + '/vizinhos [ VIP ]' + '</code>' + '\n' + '<b>' 'CEP V2 ➔ ' '</b>' '<code>' + '/cepe [ VIP ]' + '</code>' + '\n' + '<b>' 'CPF V2 ➔ ' '</b>' '<code>' + '/master [ VIP ]' + '</code>' + '\n' + '<b>' 'EMAIL ➔ ' '</b>' '<code>' + '/email [ VIP ]' + '</code>' + '\n' + '<b>' 'PARENTES ➔ ' '</b>' '<code>' + '/parentes [ VIP ]' + '</code>' + '\n' + '<b>' 'IP ➔ ' '</b>' '<code>' + '/ip [ VIP ]' + '</code>' + '\n' + '<b>' 'PLACA ➔ ' '</b>' + '<code>' '/placa [ VIP ]' '</code>' + '\n\n' + '<b>' 'CHK CC ➔</b><code>/chkcc [ VIP ]' '</code>' '\n\n' + '<b>' 'GERAR CPF ➔</b><code> /gencpf [ FREE ]' '</code>' + '\n' + '<b>' 'GERAR EMAIL ➔</b><code> /genemail [ FREE ]' + '</code>' + '\n' + '<b>' 'GERAR CNPJ ➔</b><code> /gencnpj [ FREE ]' + '</code>' '\n\n' + '<b>' 'VALIDAR CPF ➔</b><code> /validar [ VIP ]' + '</code>' + '\n\n' + '<b>' 'ID ➔ ' '</b>' '<code>' + '/id [ VIP ]' + '</code>' + '\n\n' + '<b>Coded BY ➔ @StarkVendasOFC</b>' , parse_mode='HTML')
        except:

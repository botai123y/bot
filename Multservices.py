...
PRIVADO = [1484706029,1490314214,1423774341,655617720,1446890275,529542937,1347919311,310385491,1462517899,1312399043,1114622388,1033135771]
#
#
GRUPO = [-1001357422890, -1001145542520, -1001484278128, -1001380402802]
#
#
EXCEPT = [-100132053418, -1001274836019,
-1001112418087, -1001405031853
-1001209811135] #POR ENQUANTO NADA ( APAGA O '1' )
#
#
...
def boavinda(message1):
    ...
    if ide in liste:
        ...
        bot.reply_to(message1, '<b>' + '🚫 ' + '@'+message1.chat.username + ' ❌ VOCÊ NÃO TEM BOT VIP ❌' '</b>', parse_mode='HTML')
...
def zn(nome):
            ...
            if id1 in ltnome:
                try:
                	...
                	bot.reply_to(nome, '<b>' '' '</b>', parse_mode='HTML')
            else:
...
def boavinnda(message1):
    bot.reply_to(message1, '<b>' 'ID: ' '</b>''<code>' + str(message1.chat.id) + '</code>' '\n'+ '<b>' 'NAME: ' '</b>' '<code>'+ message1.chat.first_name + '</code>' '\n' + '<b>''USERNAME: '+'@'+message1.chat.username + '</b>' , parse_mode='HTML')
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                N = bot.reply_to(men, '<b></b>', parse_mode='HTML')
            else:
                bot.reply_to(men, '<b>' '💰 COMPRE BOT VIP @StarkVendasOFC 💰' '</b>',
                             parse_mode='HTML')
            ...
            if int(idee) in permitidos:
                ...
                if men.text == '/master':
                    ...
                    try:
                        ...
                        A = bot.reply_to(men, '<b>' '' '</b>', parse_mode='HTML')
            else:
                bot.reply_to(men, '<b>' '💰 COMPRE BOT VIP @StarkVendasOFC 💰' '</b>',
                             parse_mode='HTML')
...
def sjjsn(nome):
            ...
            if id1 in ltnome:
                ...
                if men == '/nome':
                    ...
                    try:
                        bot.reply_to(nome, '<code></code>', parse_mode='HTML')
            ...
            if ideee in lib:
                if message1.text == '/trabalhos':
                    ...
                    try:
                        ...
                        bot.reply_to(message1, '<b>' + '' + '</b>', parse_mode='HTML')

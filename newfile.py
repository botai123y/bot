...
PRIVADO = [1484706029,1238013877]
#
#
GRUPO = []
#
#
EXCEPT = []  # QUANDO UM GRUPO PODER TER TELEFONE BOTA O ID AI ( TEL, NOME, CEP ETC... )
#
#
ANONY = [] # OFF
...
def boavinda(message1):
    ...
    if ide in liste:
        ...
        bot.reply_to(message1, '<b>' '😎 BROTHER TU TEM ACESSO! 😎' '</b>', parse_mode='HTML')
        ...
        bot.send_message(ide, '<b>' '✅ Adquira o seu acesso com meu Dono @StarkVendasOFC ✅' '</b>', parse_mode='HTML')
            ...
            if id1 in ltnome:
                try:
                	...
                	bot.reply_to(nome, '<b>' 'TÁ ERRADO!' '</b>', parse_mode='HTML')
                		...
                		bot.reply_to(nome, '<b>' '✅ Compre acesso com meu Dono @StarkVendasOFC ✅' '</b>', parse_mode='HTML')
...
def beroi(men):
            ...
            if int(idee) in permitidos:
                ...
                bot.reply_to(men, '<b>' '✅ Compre acesso com meu Dono @StarkVendasOFC ✅' '</b>', parse_mode='HTML')
...
def byti(men):
            ...
            if int(chtid) in permitidos:
                ...
                bot.reply_to(men, '<b>✅ Compre acesso com meu Dono @StarkVenfasOFC ✅</b>',
                             parse_mode='HTML')
...
def bqpwi(men):
            ...
            if int(idee) in permitidos:
                ...
                bot.reply_to(men, '<b>' '✅ Compre acesso com meu Dono @StarkVendasOFC ✅' '</b>',
                             parse_mode='HTML')
...
def sjjsn(nome):
            ...
            if id1 in ltnome:
                ...
                bot.reply_to(nome, '<b>✅ Compre acesso com meu Dono @StarkVendasOFC ✅</b>',
                             parse_mode='HTML')
...
def bunda(message1):
            ...
            if ideee in lib:
                ...
                bot.reply_to(message1,
                             '<b>' + '✅ Adquira acesso com meu dono @StarkVendasOFC ✅' + '</b>',
                             parse_mode='HTML')
